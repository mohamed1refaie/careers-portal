...
<div class="col s12 m4 singleArticle">
    <div class="card medium priv-card hoverable">
        <div class="card-image articleImage" style="min-height:45%;">
            ...
            <a id="deletePrivilegeBtn [[+deleteFlag]]" onclick="fnDel([[+currID]]);" class="btn-floating btn-large waves-effect waves-light red float-edit delete-btn [[+deleteFlag]]" style="bottom: 80px; right: 20px;"><i class="material-icons ">delete</i></a>

            <img style="margin-top: -100px" class="articleImage" src="../[[+image]]">
