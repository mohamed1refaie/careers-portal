...
<div class="fixed-action-btn" style="bottom: 45px; right: 24px;" id="addAlertBtnCnt">
  ...
  <ul>
    <li>
      <a class="btn-floating btn-large blue tooltipped modal-trigger popupforms" data-position="left" data-delay="50" data-tooltip="Add New Category"  id="addItem">
...
<div class="row">
  <div class="large-12 columns">
    ...
    <p class="subtitle-text">
      Manage Categories on your website.
    </p>
